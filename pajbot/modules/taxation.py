        ...
        with DBManager.create_session_scope() as db_session:
            ...
            for item in users_dict:
                ...
                for value in dates_paid:
                    if value:
                        paid_count += 1
                if min_tax and paid_count < min_tax:
                    users_to_timeout.append(user_dict_obj)
                elif False not in dates_paid:
            ...
            if self.settings["number_points_tax"]:
                ...
                action_messages.append(
                    f"Awarded {len(users_to_award)} users {self.settings['number_points_tax']} points each for paying tax."
                )
